...
We are using the [DarkaOnLine/L5-Swagger](https://github.com/DarkaOnLine/L5-Swagger) to create a swagger UI client and swagger API documentation. 
This package is based on [swagger-PHP](http://zircote.com/swagger-php) and [swagger-UI](https://github.com/swagger-api/swagger-ui).
